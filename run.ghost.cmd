...
nhcolor 07 "  CURRENT OS: %Green%%DFMT6% %White%| %Green%VER: %DFMT7% [%CODENAME%] %White%| %Green%BUILD: %Green%%DFMT5%.%UBRDEC% %White%| %Green%ARCH: %OSARC% %White%| %Yellow%%Edition%
...
nhcolor 04 " [16] | %Lightgray%Visual C++ Redistributables AIO 2021-07-14 (system) %Red%: by State or Country & Sync now. Type Timezone to Change.:"
...
:WTHx64
cls
nhcolor 08 " %Red%Seems your internet is blocking the servers, Please use CloudFlare DND / Google DNS or Any VPN. "
timeout /t 10 >nul
exit
:WTHx642
cls
...
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
nhcolor 06 " %Green%OPT %Yellow%|     %White%| LIST                                            | %Red%SIZE   %White%|
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
nhcolor 06 " %Green%[50]%Yellow%| %White%UWP | Microsoft Photos 2020.20110.5002.0              | %Red% 60MB  %White%|
...
cls
:startdownload
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://github.com/abbodi1406/vcredist/releases/download/v0.51.0/VisualCppRedist_AIO_x86_x64_51.zip" -t 15 -O "VisualCppRedist_AIO_x86_x64_51.zip"
cls
7z1900-extra\7za x VisualCppRedist_AIO_x86_x64_51.zip -aoa
...
nhcolor 06 " %Green%[2] %Yellow%| %White%LibreOffice 7.1.2 Fresh x86                  | %Red%278MB   %Green%[33] %Yellow%| %White%IObit Driver Booster 8.6.0.522 RePack     | %Red% 19MB
...
cls
:startdownload
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3uPy1G9" -o"Microsoft.MSPaint_2020.420.2001.0_neutral_~_8wekyb3d8bbwe.Appx"
cls
:Paint3dInstall
cls
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false --http-user="rsload.net" --http-passwd="rsload.net" "http://95.141.198.238/noload2/files/074/iobit_driver_booster_8.6.0.522.zip" -o"IOBit.Driver.Booster.v8.6.0.522.repack.zip"
timeout /t 5 >nul
cls
7z1900-extra\7za x "IOBit.Driver.Booster.v8.6.0.522.repack.zip" -aoa -pdb -o"IOBit.Driver.Booster.v8.6.0.522.repack"
cls
echo. The program is being installed... Wait for the operation to complete.
timeout /t 3 >nul
cd "IOBit.Driver.Booster.v8.6.0.522.repack"
FOR %%i IN ("IObit Driver Booster*.exe") DO Set FileName="%%i"
%FileName% /SILENT
cd..
rd /s /q "IOBit.Driver.Booster.v8.6.0.522.repack" >nul 2>nul
...
:startdownload
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3vaqMIW" -o"Microsoft.WindowsCalculator_2020.2103.8.0_neutral_~_8wekyb3d8bbwe.Appx"
cls
nhcolor 08 " MD5 HASH CHECK"
nhcolor 08 " --------------"
for /f %%N in ('hashsum /a md5 Microsoft.WindowsCalculator_2020.2103.8.0_neutral_~_8wekyb3d8bbwe.Appx') do set "MD5=%%N"
...
title GHOST TOOLBOX 1.9.0.5 %GARC% && goto imnotdoneyet
::cls
::cd "%systemdrive%\ghost toolbox\wget"
...
goto :noupdate
:for21H1
echo wscript.quit MsgBox ("Found new update 19043.1151, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:for2009
echo wscript.quit MsgBox ("Found new update 19042.1151, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2004
echo wscript.quit MsgBox ("Found new update 19041.1151, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for1909
echo wscript.quit MsgBox ("Found new update 18363.1316, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:for1809
echo wscript.quit MsgBox ("Found new update 17763.1935, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:storetest001
cls
echo %White%Checking files and Windows 10 Version...
timeout /t 10 >nul
cls
cd "%systemdrive%\ghost toolbox\wget"
for /f "tokens=2*" %%a in ('reg query "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion" /v ReleaseId') do set "var=%%b"
...
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://ghosttoolbox.shortcm.li/Microsoft.WindowsStore_11811.1001.2713.0_neutral_~_8wekyb3d8bbwe.Appx" -o"Microsoft.WindowsStore_11811.1001.2713.0_neutral_~_8wekyb3d8bbwe.Appx"
echo %White%=======================================================================
:installx641607
echo Taking ownership..please wait...
::powershell expand-archive -path 7z1900-extra.zip -force
...
if %MD5% equ fcfb7fe3207cf1e5125fa1fc6c55ec0b (
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3o0cs3o" -o"microsoft.windows.photos_8wekyb3d8bbwe.appx"
cls
nhcolor 08 " --------------"
for /f %%N in ('hashsum /a md5 microsoft.windows.photos_8wekyb3d8bbwe.appx') do set "MD5=%%N"
if %MD5% equ fcfb7fe3207cf1e5125fa1fc6c55ec0b (
...
:errordlphotos
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3tAj0qF" -o"microsoft.windows.photos_8wekyb3d8bbwe.appx"
cls
:install
cls
nhcolor 08 " MD5 HASH CHECK"
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --no-conf --console-log-level=warn -o"microsoft.windows.photos_8wekyb3d8bbwe.appx" --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3o0cs3o"
cls
:install
cls
nhcolor 08 " MD5 HASH CHECK"
